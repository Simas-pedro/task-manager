import { ArrowRight, CheckIcon, Trash2 } from "lucide-react";
      ...
      {tasks.map((task) => (
        <li key={task.id} className="flex gap-2">
          ...
          <Button
            ...
            className={`bg-gray-500/15 text-white w-full p-2 rounded-md shadow-lg hover:bg-gray-500/30 transition cursor-pointer active:bg-gray-500/0 active:transition-none flex justify-center ${
          ...
          >
            {task.isCompleted ? <CheckIcon /> : null} {/*Renderiza o Icone quando completo*/}
            {task.title} {/*Renderiza o titulo da task*/}
          </Button>
